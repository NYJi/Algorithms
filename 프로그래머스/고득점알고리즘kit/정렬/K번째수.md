...
### 출력
<img width="465" height="87" alt="image" src="https://github.com/user-attachments/assets/aff88df9-126e-4c70-b9c9-0d698e0a5865" />
...
def solution(array, commands):
    ...
    # i에서 j까지 자르고 정렬
    # 해당 리스트에서 k-1 인덱스에 해당하는 값 lst 넣기
    
    for i,j,k in commands:
        per_arr = array[i-1:j]
        per_arr.sort()
        lst.append(per_arr[k-1])
